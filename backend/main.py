...
def _startup():
    ...
    # Optional one-shot admin bootstrap for cloud hosts without a shell.
...
app.include_router(auth.router)          # /api/auth/login, /logout, /me (JWT)
...
# Demo student results — no ML dependencies.
from app.routes.student import demo_router as student_demo_router
app.include_router(student_demo_router)    # /student/{id}/results
